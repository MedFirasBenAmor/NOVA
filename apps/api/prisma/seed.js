...
const autoR1 = [
    compactDefinition({ key: 'auto.additional_driver_exists', label: 'Additional driver exists', description: 'Whether the customer wants to add an additional auto driver.', product: client_1.Product.AUTO, category: 'ADDITIONAL_DRIVER', entityType: client_1.EntityType.CUSTOMER, dataType: client_1.DataType.BOOLEAN, requirementType: client_1.RequirementType.REQUIRED }),
...
const homeConditional = [
    ...
    { key: 'home_claim.type', label: 'Home claim type', description: 'The type of a home claim.', product: client_1.Product.HOME, category: 'PROPERTY_CLAIMS', entityType: client_1.EntityType.CLAIM, dataType: client_1.DataType.STRING, requirementType: client_1.RequirementType.CONDITIONAL, requiredWhen: { key: 'property.claims_last_5_years', operator: 'EQ', value: true } },
    { key: 'home_claim.year', label: 'Home claim year', description: 'The year of a home claim.', product: client_1.Product.HOME, category: 'PROPERTY_CLAIMS', entityType: client_1.EntityType.CLAIM, dataType: client_1.DataType.NUMBER, requirementType: client_1.RequirementType.CONDITIONAL, requiredWhen: { key: 'property.claims_last_5_years', operator: 'EQ', value: true } },
    { key: 'home_claim.description', label: 'Home claim description', description: 'A concise description of a home claim.', product: client_1.Product.HOME, category: 'PROPERTY_CLAIMS', entityType: client_1.EntityType.CLAIM, dataType: client_1.DataType.STRING, requirementType: client_1.RequirementType.CONDITIONAL, requiredWhen: { key: 'property.claims_last_5_years', operator: 'EQ', value: true } },
    { key: 'property.claim_count_last_5_years', label: 'Property claim count last five years', description: 'Legacy property-level claim summary; non-blocking because repeatable HOME claims are captured under home_claim.*.', product: client_1.Product.HOME, category: 'PROPERTY_CLAIMS', entityType: client_1.EntityType.PROPERTY, dataType: client_1.DataType.NUMBER, requirementType: client_1.RequirementType.OPTIONAL },
    { key: 'property.claim_most_recent_year', label: 'Most recent property claim year', description: 'Legacy property-level claim summary; non-blocking because repeatable HOME claims are captured under home_claim.*.', product: client_1.Product.HOME, category: 'PROPERTY_CLAIMS', entityType: client_1.EntityType.PROPERTY, dataType: client_1.DataType.NUMBER, requirementType: client_1.RequirementType.OPTIONAL },
    { key: 'property.claim_type', label: 'Property claim type', description: 'Legacy property-level claim summary; non-blocking because repeatable HOME claims are captured under home_claim.*.', product: client_1.Product.HOME, category: 'PROPERTY_CLAIMS', entityType: client_1.EntityType.PROPERTY, dataType: client_1.DataType.STRING, requirementType: client_1.RequirementType.OPTIONAL },
    ...
    { key: 'co_applicant.civility', label: 'Co-applicant civility', description: 'The co-applicant civility or title from the habitation intake reference.', product: client_1.Product.HOME, category: 'CO_APPLICANT', entityType: client_1.EntityType.CO_APPLICANT, dataType: client_1.DataType.STRING, requirementType: client_1.RequirementType.CONDITIONAL, requiredWhen: { key: 'property.has_co_applicant', operator: 'EQ', value: true } },
    { key: 'co_applicant.first_name', label: 'Co-applicant first name', description: 'The co-applicant first name.', product: client_1.Product.HOME, category: 'CO_APPLICANT', entityType: client_1.EntityType.CO_APPLICANT, dataType: client_1.DataType.STRING, requirementType: client_1.RequirementType.CONDITIONAL, requiredWhen: { key: 'property.has_co_applicant', operator: 'EQ', value: true } },
    { key: 'co_applicant.last_name', label: 'Co-applicant last name', description: 'The co-applicant last name.', product: client_1.Product.HOME, category: 'CO_APPLICANT', entityType: client_1.EntityType.CO_APPLICANT, dataType: client_1.DataType.STRING, requirementType: client_1.RequirementType.CONDITIONAL, requiredWhen: { key: 'property.has_co_applicant', operator: 'EQ', value: true } },
    { key: 'co_applicant.date_of_birth', label: 'Co-applicant date of birth', description: 'The co-applicant date of birth.', product: client_1.Product.HOME, category: 'CO_APPLICANT', entityType: client_1.EntityType.CO_APPLICANT, dataType: client_1.DataType.DATE, requirementType: client_1.RequirementType.CONDITIONAL, requiredWhen: { key: 'property.has_co_applicant', operator: 'EQ', value: true } },
    { key: 'co_applicant.occupation', label: 'Co-applicant occupation', description: 'The co-applicant profession or occupation.', product: client_1.Product.HOME, category: 'CO_APPLICANT', entityType: client_1.EntityType.CO_APPLICANT, dataType: client_1.DataType.STRING, requirementType: client_1.RequirementType.CONDITIONAL, requiredWhen: { key: 'property.has_co_applicant', operator: 'EQ', value: true } },
    { key: 'co_applicant.relationship', label: 'Co-applicant relationship', description: 'The co-applicant relationship with the proposer.', product: client_1.Product.HOME, category: 'CO_APPLICANT', entityType: client_1.EntityType.CO_APPLICANT, dataType: client_1.DataType.STRING, requirementType: client_1.RequirementType.CONDITIONAL, requiredWhen: { key: 'property.has_co_applicant', operator: 'EQ', value: true } },
    { key: 'co_applicant.is_vehicle_driver', label: 'Co-applicant is vehicle driver', description: 'Whether the co-applicant is also a vehicle driver.', product: client_1.Product.HOME, category: 'CO_APPLICANT', entityType: client_1.EntityType.CO_APPLICANT, dataType: client_1.DataType.BOOLEAN, requirementType: client_1.RequirementType.CONDITIONAL, requiredWhen: { key: 'property.has_co_applicant', operator: 'EQ', value: true } },
];
const home = [
    ...homeRequired,
    ...homeOptional,
